/**
 * Cái ui của game á, t chưa thấy m có file mà có cái này nên t điền trước. Nhớ có thêm file hình ảnh mới chạy được nha.
 * Cái này là thanh máu, trạng thái, mana, ...
 * bảng thông tin vũ khí giống roblox :))))
 */
